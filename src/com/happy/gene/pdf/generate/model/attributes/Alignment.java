...
public class Alignment implements ICloneable
{
    ...
    public static Alignment newInstance() { return new Alignment(); }
    public static Alignment newInstance(int horizontal, int vertical) { return new Alignment(horizontal, vertical); }
    public static Alignment newInstance(String horizontal, String vertical) { return new Alignment(horizontal, vertical); }
    ...
    @Override
    public ICloneable createBlank() { return new Alignment(); }
